...
/**
  ...
  *  (device_id 0x01) и светодиодной балкой на выходе L1 (DRV1): яркость
  *  0..100 % задаётся потенциометром LA42DWQ-22 на входе ADC_IN_1, в крайнем
  *  положении потенциометра включается стробоскоп. Периодически шлёт
  *  телеметрию своих дискретных входов.
  *
