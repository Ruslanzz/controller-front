...
uint8_t device_id = 0x04;   /* узел передней светотехники */
...
static void MX_ADC1_Init(void)
{
  ...
  /* Каналы 1..8 на ранги 1..8. Канал 1 (PA1) — потенциометр яркости балки. */
...
/**
  * @brief TIM4 Initialization Function (ШИМ светодиодной балки: CH1/CH2 — DRV1)
  */
static void MX_TIM4_Init(void)
{
  TIM_MasterConfigTypeDef sMasterConfig = {0};
  ...
  htim4.Init.Period = PWM_PERIOD-1;   /* 72 МГц / 72 / 3333 ≈ 300 Гц */
